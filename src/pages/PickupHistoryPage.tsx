...
import { mockPickupHistory, mockImpactMetrics } from '../data/mockData';

const PickupHistoryPage: React.FC = () => {
  const totalEarnings = mockPickupHistory.length * 50; // Mock: ₹50 per pickup
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">{mockPickupHistory.length}</p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="text-center">
              <div className="bg-green-50 p-6 rounded-lg">
                ...
                <p className="text-3xl font-bold text-green-600 mt-2">{mockImpactMetrics.wasteProcessed} kg</p>
                <p className="text-sm text-gray-600 mt-1">Equivalent to recycling {Math.round(mockImpactMetrics.wasteProcessed / 10)} plastic bottles</p>
              </div>
            </div>
            <div className="text-center">
              <div className="bg-blue-50 p-6 rounded-lg">
                ...
                <p className="text-3xl font-bold text-blue-600 mt-2">{mockImpactMetrics.co2Reduction} kg</p>
                <p className="text-sm text-gray-600 mt-1">Equivalent to planting {Math.round(mockImpactMetrics.co2Reduction / 20)} trees</p>
              </div>
            </div>
          </div>
        </div>
